...
To stage the evaluator, the usual recipe applies: lift introductory forms that
produce values, while elimination forms that consume values
...
\todo{Maybe move the paragraphs below to a "discussion" section making the conclusion shorter and more focused}
