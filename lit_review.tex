...
(let x0
  |\colorbox{green}{(lambda f0 x1}\textcolor{red}{<=== Takes user input}|
    ...
    (let x7 (x2 x6) (cons x7 '.)))))))) (x0 '.)) |\label{mline:factorial_input}|
        ...
        \label{lst:secd_fib_ped}
    \end{subfigure}
\caption{Example Fibonacci}
\label{lst:secd_fib_all}
\end{figure}
...
((lambda (fun)
 ...
 DUM NIL LDF
    ...
    \end{subfigure}
\caption{Example Fibonacci on \mevl}
...
\subsection{Staging \texorpdfstring{\mevl}{Lg}}
