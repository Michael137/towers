...
its return values, the process of staging an abstract machine requires a more careful sophisticated binding-time analysis with
({\it i\/}) design of its division rules
