...
\todo{need to better emphasize what the paper does vs what the thesis did}
...
\todo{missing sections and elsewhere}
}
    \label{fig:tombstone}
\end{figure*}
...
\todo{do}
\subsection{Collapsing Reflective Towers}\label{subsec:collapse}
