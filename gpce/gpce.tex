...
\begin{figure*}
    ...
    \begin{tikzpicture}
        \matrix (m) [matrix of nodes,nodes={minimum width=4.2em,minimum  height=1.7em}]
        {
            Program                 \\
            \mevl                   \\
            \mevl                   \\
          ...
          \draw (m-1-1.north west) |- (m-2-1.south east) |- (m-4-1.south west) |- (m-6-1.south east) |- (m-8-1.south west) -- (m-9-1.south) -- (m-8-1.south east);
          \draw (m-1-1.north west) -| (m-2-1.south east) -| (m-4-1.south west) -| (m-6-1.south east) -| (m-8-1.south west);
    \end{tikzpicture}
    \end{subfigure}
...
and reduced static expressions in Pink's operators to achieve optimal residualization.
