...
// (LETREC FAC (FAC LAMBDA (X) (IF (EQ X (QUOTE 1)) (QUOTE 1) (MUL X (FAC (SUB X (QUOTE 1)))))))

// testExec "(NIL 2 1 13 2 10 13 3 (6 NIL 3 (2 0 1 (1.1) 14 8 (1 (1.2) 9) (NIL 1 (1.2) 1 (1.1) 17 13 1 (3.2) 1 (1.1) 16 13 1 (2.1) 4 9) 5) 13 3 (NIL 1 (2.2) 13 1 (2.1) 13 1 (1.1) 4 5) 7 5) 4 21)" "(3 1)" "random" // (DUM LDF (LD (0.0) STOP) RAP)

// NIL 2 1 CONS LDC 10 CONS LDF
//                         (DUM NIL LDF
//                             (LDC 0 LD (1 1) EQ SEL
